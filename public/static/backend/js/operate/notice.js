    ...
    addSubmit:function (response){
        if(response.status){
            dialog.confirm({
                ...
                cancel_btn:'返回帮助公告列表',
                ok_callback:function(){
                    window.location.href = App.createUrl('/backend/notice/add');;
                },
                cancel_callback:function(){
                    window.location.href = App.createUrl('/backend/notice/list');
                }
            });
        }
        else{
